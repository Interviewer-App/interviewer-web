...
const CandidateProfileCard = ({ candidate, colorTheme }) => {
      ...
      <CardContent>
        <div className="flex flex-col space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xl font-bold text-gray-100">{candidate.overallScore}/50</span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-xl font-bold text-gray-100">{candidate.timeSpent} mins</span>
          </div>
