...
const SidebarHeader = React.forwardRef(({ className, ...props }, ref) => {
  return (
    (<div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 bg-zinc-900", className)}
      {...props} />)
  );
})
...
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => {
  return (
    (<div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden bg-zinc-900 before:border-none after:border-none",
        className
      )}
      {...props} />)
  );
