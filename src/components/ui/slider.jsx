...
const Slider = React.forwardRef(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    <SliderPrimitive.Track
      className="relative h-2 w-full grow overflow-hidden rounded-full bg-lightred dark:bg-neutral-800">
      <SliderPrimitive.Range className="absolute h-full bg-neutral-900 dark:bg-lightred" />
    </SliderPrimitive.Track>
