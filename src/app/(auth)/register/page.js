    ...
    <div className=" relative overflow-hidden bg-cover flex flex-col items-center justify-center h-lvh w-full text-white">
      ...
      <div className="h-fit md:max-h-[700px] w-[90%] md:w-[60%] max-w-[500px] bg-gradient-to-br from-[#1f2126] to-[#17191d] rounded-lg flex justify-between">
        {/* <div className=" hidden lg:block w-[40%] h-full relative">
          ...
          <Tabs defaultValue="CANDIDATE" className=" w-full py-10 px-14 relative rounded-tr-lg"  value={role}
            ...
            <TabsList className=" w-full flex items-center justify-between absolute top-0 left-0 h-12">
              <TabsTrigger className="h-10 w-[50%] text-center text-sm cursor-pointer transition-all duration-[1000ms]" value="CANDIDATE">CANDIDATE</TabsTrigger>
              <TabsTrigger className="h-10 w-[50%] text-center text-sm cursor-pointer transition-all duration-[1000ms]" value="COMPANY">COMPANY</TabsTrigger>
            </TabsList>
                ...
                <div className=" w-full flex items-start justify-between mb-6">
                  <div className=" w-[48%] relative">
                    <input
                      ...
                      required
                      className={` h-[45px] w-full rounded-lg text-sm border-0 bg-[#32353b] placeholder-[#737883] px-6 py-2 ${isValidPassword ? " border-2 border-lightred" : ""
                        }`}
                    />
                    {showPassword ? (
                      <IoEye
                  ...
                  <div className=" w-[48%] relative">
                    <input
                      ...
                      required
                      className={` h-[45px] w-full rounded-lg text-sm border-0 bg-[#32353b] px-6 py-2 appearance-none ${isPasswordMissMatch ? " border-2 border-lightred" : ""
                        }`}
                    />
                    {showPasswordConf ? (
                      <IoEye
